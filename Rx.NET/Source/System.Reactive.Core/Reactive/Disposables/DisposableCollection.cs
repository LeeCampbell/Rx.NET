...
namespace System.Reactive.Disposables
{
    ...
    /// </summary>
    public sealed class DisposableCollection : ICollection<IDisposable>, ICancelable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Reactive.Disposables.DisposableCollection"/> class with no disposables contained by it initially.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Reactive.Disposables.DisposableCollection"/> class with the specified number of disposables.
        /// </summary>
        /// <param name="capacity">The number of disposables that the new DisposableCollection can initially store.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Reactive.Disposables.DisposableCollection"/> class from a group of disposables.
        /// </summary>
        ...
        /// <summary>
        /// Gets the number of disposables contained in the DisposableCollection.
        /// </summary>
        public int Count
        {
            get
        ...
        /// <summary>
        /// Adds a disposable to the DisposableCollection or disposes the disposable if the DisposableCollection is disposed.
        /// </summary>
        ...
        /// <summary>
        /// Removes and disposes the first occurrence of a disposable from the DisposableCollection.
        /// </summary>
        ...
        /// <summary>
        /// Removes and disposes all disposables from the DisposableCollection, but does not dispose the DisposableCollection.
        /// </summary>
        public void Clear()
        {
            var currentDisposables = default(IDisposable[]);
        ...
        /// <summary>
        /// Determines whether the DisposableCollection contains a specific disposable.
        /// </summary>
        ...
        /// <summary>
        /// Copies the disposables contained in the DisposableCollection to an array, starting at a particular array index.
        /// </summary>
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the DisposableCollection.
        /// </summary>
