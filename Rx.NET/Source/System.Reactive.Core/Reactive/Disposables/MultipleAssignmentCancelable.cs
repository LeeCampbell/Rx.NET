namespace System.Reactive.Disposables
{
    ...
    /// Allows consumer to check if the resource has been disposed.
    /// </summary>
    public sealed class MultipleAssignmentCancelable : ICancelable
    {
        private readonly object _gate = new object();
        private IDisposable _current;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:System.Reactive.Disposables.MultipleAssignmentCancelable"/> class with no current underlying disposable.
        /// </summary>
        public MultipleAssignmentCancelable()
        {
        }
        ...
        /// </summary>
        /// <remarks>If the MultipleAssignmentCancelable has already been disposed, assignment to this property causes immediate disposal of the given disposable object.</remarks>
